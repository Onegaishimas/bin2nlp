...
class ResultCache:
    ...
    def _generate_config_hash(self, analysis_config: Dict[str, Any]) -> str:
        ...
        key_params = [
            'depth', 'timeout_seconds', 'focus_areas', 'enable_security_scan',
            'max_functions', 'max_strings', 'security_scan_depth'
        ]
    ...
    def _extract_tags(self, file_hash: str, analysis_config: Dict[str, Any]) -> Set[str]:
        ...
        if isinstance(focus_areas, list):
            for area in focus_areas:
                tags.add(f"focus:{area}")
        
        # Add security scan tag
        if analysis_config.get('enable_security_scan', False):
            tags.add("security_scan")
    ...
    async def invalidate_by_tag(self, tag: str) -> int:
        ...
        Args:
            tag: Tag to invalidate (e.g., "depth:comprehensive", "security_scan")
