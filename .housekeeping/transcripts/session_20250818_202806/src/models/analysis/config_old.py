...
from ..shared.enums import Platform, FileFormat, get_file_format_from_extension
...
class DecompilationConfig(BaseModel, AnalysisModelMixin):
    ...
    def serialize_llm_provider(self, value: Optional[str]) -> Optional[str]:
        """Serialize LLM provider as string."""
        return value
